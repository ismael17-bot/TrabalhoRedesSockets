...
public class CriarPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Padão", "Customizado" }));
        ...
        jTextField1.getAccessibleContext().setAccessibleName("nomeSala");
        jTextField2.getAccessibleContext().setAccessibleName("senhaSala");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        new CustomizaJogo().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CriarPartida.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
